...
namespace config {
    inline const std::vector<std::string> RELIABLE_PROVIDERS = {
    ...
    struct GuildConfig {
        ...
        std::map<int, dpp::snowflake> lvl_roles = {
            {5, 1482905611535519877ULL}, {10, 1482903838443835452ULL},
            {15, 1482903879686426876ULL}, {20, 1482904022355673231ULL},
            {25, 1482904091083673763ULL}, {30, 1482475514022330470ULL},
            {35, 1482904194838036530ULL}, {40, 1482904249749737583ULL},
            {50, 1485095100236304464ULL}, {60, 1485095100236304464ULL},
            {70, 1485095358626529280ULL}, {80, 1485095456488034325ULL},
            {90, 1485095668124094616ULL}
        };

        void update_stupid() {
            stupid_roles = {leader_role, num2_role, num3_role, loser_role, bot2_role, bot3_role};
        }
    };
